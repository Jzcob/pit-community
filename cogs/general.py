...
class general(commands.Cog):
    ...
    @app_commands.checks.has_any_role(config.moderator, config.administrators, config.transparent_admin, config.true_admin)
    async def editEmbed(self, interaction: discord.Interaction, message_id: str, title: str, message: str, image: discord.Attachment=None, custom_color: discord.Color=None, channel: discord.TextChannel = None):
        try:
